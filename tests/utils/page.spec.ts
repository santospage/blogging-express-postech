...
describe('pageDetails', () => {
  xit('should return default values when no parameters are provided', () => {
  ...
  xit('should handle ordering with ascending and descending', () => {
    const paramsAsc = {
  ...
  xit('should default sort order to ascending when sortOrder is not "1" or "-1"', () => {
    const params = {
      ordering: 'title:abc',
    };
    const result = pageDetails(params);
